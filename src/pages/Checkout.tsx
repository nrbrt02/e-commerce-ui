...
const Checkout: React.FC = () => {
  ...
  // Payment methods - Updated to include PayPal
                ...
                <div className="bg-sky-50 border border-sky-100 rounded-lg p-4 mb-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <button
                        onClick={handleLoginRequirement}
                        className="bg-sky-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-sky-700 transition-colors duration-200"
                      >
                        Login / Register
                      </button>
                    </div>
                  ...
                  <div className="mb-6">
                    <div className="bg-gray-50 p-4 rounded-lg mb-4">
                          ...
                          createOrder={(_: any, actions: any) => {
                            return actions.order.create({
                              ...
                              purchase_units: [
                                {
                                  amount: {
                                    value: (totalOrderAmount / 1000).toFixed(2),
                                    currency_code: "USD",
                                  },
                                  description: `Order from FashionStore (${cartItems.length} items)`,
                                },
                              ],
                            });
                          }}
                      ...
                      <div className="mt-4 flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <p>PayPal keeps your financial information secure</p>
                      </div>
                    </div>
                  </div>
                )}
