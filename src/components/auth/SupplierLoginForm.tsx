...
const SupplierLoginForm: React.FC = () => {
  const { login, error, clearError, setAuthModalView, setUserType } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await login(email, password, 'supplier');
  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md mx-auto">
      <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Supplier Login</h2>
